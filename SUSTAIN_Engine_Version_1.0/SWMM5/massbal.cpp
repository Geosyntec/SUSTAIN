...
////////////////////////////////////////////////////////////
//  Add quality of any ponded water to total. (LR - 7/5/06 )
////////////////////////////////////////////////////////////
...
void massbal_updateGwaterTotals(float vInfil, float vUpperEvap, float vLowerEvap,
                                float vLowerPerc, float vGwater)
//
...
void massbal_updateLoadingTotals(int type, int p, float w)
//
//  Input:   type = type of inflow
//           p    = pollutant index
//           w    = mass loading
...
//
{
    ...
    for ( j=0; j<Nobjects[NODE]; j++)
    {
        ...
        {
            NodeOutflow[j] += (Node[j].outflow + Node[j].overflow) * tStep;
        }
    }
}
...
///////////////////////////////////////////////////////////////////
//  Storage is simply whatever the node's volume is. (LR - 3/10/06)
///////////////////////////////////////////////////////////////////
...
/*
        ...
        else if ( Node[j].fullVolume > 0.0 &&
                  Node[j].newVolume > Node[j].fullVolume )
        {
            nodeStorage = Node[j].newVolume - Node[j].fullVolume;
        }
        else nodeStorage = 0.0;
*/
...
void massbal_getSysFlows(float f, float sysFlows[])
//
