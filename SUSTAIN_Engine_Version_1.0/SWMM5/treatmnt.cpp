...
static float  Dt;                      // curent time step (sec)
static float  Q;                       // node inflow (cfs)
static float  V;                       // node volume (ft3)
static float* R;                       // array of pollut. removals
static TTreatment* Treatment;          // pointer to Treatment object

//////////////////////////////////////////
// New array variable added. (LR - 9/5/05)
//////////////////////////////////////////
static float*  Cin;                    // node inflow concentrations
...
//  Local functions
//-----------------------------------------------------------------------------
int    createTreatment(int node);
float  getRemoval(int pollut);
...
//
{
    ...
    char* expr;
    int   i, j, k, p;
    ExprTree* equation;                // ptr. to a math. expression tree
...
void  treatmnt_setInflow(int j, float qIn, float wIn[])
//
//  Input:   j = node index
...
void  treatmnt_treat(int j, float q, float v, float tStep)
//////////////////////////////////////////////////////////
// This function was significantly modified. (LR - 7/5/06)
//////////////////////////////////////////////////////////
//
//  Input:   j     = node index
...
//
{
    ...
    float cOut;                        // concentration after treatment
    float cLost;                       // concentration lost by treatment
    float massLost;                    // mass lost by treatment per time step
...
///////////////////////////////////////////////////////////////////
//  Use influent concentration for REMOVAL equations. (LR - 9/5/05)
///////////////////////////////////////////////////////////////////
...
//
{
    float c0 = Node[J].newQual[p];     // initial node concentration
    float r;                           // removal value
