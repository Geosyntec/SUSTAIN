...
#define ERR134 "\n  ERROR 134: Node %s has more than one DUMMY outlet link."
...
#define ERR171 "\n  ERROR 171: Curve %s has its data out of sequence."
...
///////////////////////////////////////////
//  New error message added. (LR - 7/5/06 )
///////////////////////////////////////////
#define ERR116 "\n  ERROR 116: invalid offset for Conduit %s."

////////////////////////////////////////////////////////////////////////////
//  NOTE: Need to update MAXERRMSG, ErrorMsgs[], ErrorCodes[], and ErrorType
//        (in error.h) whenever a new error message is added.
/////////////////////////////////////////////////////////////////////////////

#define MAXERRMSG 85                  // highest sequential index of error codes

char* ErrorMsgs[] =
    { "",     ERR101, ERR103, ERR105, ERR107, ERR108,
      ERR109, ERR111, ERR113, ERR114, ERR115,
      ERR117, ERR119, ERR121, ERR131, ERR133,
      ERR134, ERR135, ERR136, ERR137, ERR138,
      ERR139, ERR141, ERR143, ERR145, ERR151,
      ERR153, ERR155, ERR161, ERR171, ERR173,
      ERR191, ERR193, ERR195, ERR200, ERR201,
      ERR203, ERR205, ERR207, ERR209, ERR211,
      ERR213, ERR217, ERR219, ERR221, ERR223,
      ERR225, ERR227, ERR229, ERR231, ERR233,
      ERR301, ERR303, ERR305, ERR307, ERR309,
      ERR311, ERR313, ERR315, ERR317, ERR319,
      ERR321, ERR323, ERR325, ERR327, ERR329,
      ERR330, ERR331, ERR333, ERR335, ERR336,
      ERR337, ERR338, ERR339, ERR341, ERR343,
      ERR345, ERR351, ERR353, ERR355, ERR357,
      ERR401, ERR402, ERR403, ERR405, ERR116};

int ErrorCodes[] =
    { 0,   101, 103, 105, 107, 108,
      109, 111, 113, 114, 115,
      117, 119, 121, 131, 133,
      134, 135, 136, 137, 138,
      139, 141, 143, 145, 151,
