...
static void   evalSofA(float a, float* f, float* df);
...
static float  getQcritical(float yc);
...
///////////////////////////////////////////////
//  0.7853982 replaced with PI/4. (LR - 9/5/05)
///////////////////////////////////////////////
...
////////////////////////////////////////////
// 0.7853982 replaced by PI/4. (LR - 9/5/05)
////////////////////////////////////////////
        xsect->aFull = PI / 4.0 * xsect->yFull * xsect->yFull;
    ...
    case HORIZ_ELLIPSE:
/////////////////////////////////////////////////////////
// Modified to read standard ellipse sizes. (LR - 9/5/05)
/////////////////////////////////////////////////////////
        ...
        else
        {
            ...
            // This code replaced by tabulated standard sizes
            //if ( xsect->wMax == 0.0 )
            //{
            //    wFactor = 1.64;
            //    if ( xsect->yFull > 1.5) wFactor = 1.56;
            //    xsect->wMax  = wFactor * xsect->yFull;
            //}
...
/////////////////////////////////////////////////////////
        ...
        else
        {
            ...
            //{
            //    wFactor = 1.64;
            //    if ( xsect->yFull > 2.0) wFactor = 1.56;
            //    xsect->wMax  = xsect->yFull / wFactor;
            //}
...
//////////////////////////////////////////////////////////////////////
//  sMax and its area are now part of Transect object. (LR - 3/10/06)
//////////////////////////////////////////////////////////////////////
    //xsect->sMax  = xsect->sFull;
...
////////////////////////////////////////////
//  0.785398 replaced by PI/4. (LR - 9/5/05)
////////////////////////////////////////////
            PI / 4.0 * xsect->wMax * xsect->wMax * (0.96-0.5);
    }

/////////////////////////////////////////////////////////////////////////
//  Amax for irregular shapes now stored in aBot property. (LR - 3/10/06)
/////////////////////////////////////////////////////////////////////////
...
//
{
    ...
    switch ( xsect->type )
    {
      case CIRCULAR: return circ_getSofA(xsect, a);
...
void evalSofA(float a, float* f, float* df)
//
//  Input:   a = area
...
{
    float  y1 = 0.0;
    float  y2 = 0.99 * (float)xsect->yFull;
    float  yc;
    double q0, q1, q2;
...
////////////////////////////////////////////////////
//  Adjustment for top surface added. (LR - 3/10/06)
////////////////////////////////////////////////////
...
///////////////////////////////////////
//  New variables added. (LR - 3/10/06)
///////////////////////////////////////
    double p, alf;
...
///////////////////////////////////////////////////////
//  Revision to account for top surface. (LR - 3/10/06)
///////////////////////////////////////////////////////
