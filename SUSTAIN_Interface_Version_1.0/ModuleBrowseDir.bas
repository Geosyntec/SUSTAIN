Attribute VB_Name = "ModuleBrowseDir"
'=====================================================================================
...
Public Function BrowseForSpecificFolder(Title As String, StartDir As String) As String
  ...
  szTitle = Title
  With tBrowseInfo
    .hWndOwner = gApplication.hWnd 'hWndAccessApp 'owner.hWnd
  ...
  If (lpIDList) Then
    ...
    BrowseForSpecificFolder = sBuffer
  Else
    BrowseForSpecificFolder = ""
  End If
